    ...
    <main className={styles.page}>
        ...
        <section className="aboutSection">
            ...
            <div className="githubProfiles">
                <Link href="https://github.com/Ksawert560" target="_blank" title="Ksawert"><img src="https://avatars.githubusercontent.com/u/56079058?v=4" alt="githubImg/ksawert.png" className="githubPicture"></img></Link>
                <span> Ksawery Kucz - responsible for creating the app's smooth and modern design, as well as building the frontend.</span>
            </div>
            <div className="githubProfiles">
            <Link href="https://github.com/TestkaJakub" target="_blank" title="TestkaJakub"><img src="https://avatars.githubusercontent.com/u/84832891?v=4" alt="githubImg/pseu.png" className="githubPicture"></img></Link>
            ...
            <div className="githubProfiles">
                <Link href="https://github.com/mskubarc" target="_blank" title="mskubarc"><img src="https://avatars.githubusercontent.com/u/195991039?s=96&v=4" alt="githubImg/mskubarc.png" className="githubPicture"></img></Link>
