  ...
  return (
    <section className="footerWraper" style={styles.page}>
        ...
        <div className="footerImgWraper">
            <Link href="https://github.com/Ksawert560" target="_blank">
                <img src="githubImg/ksawert.png" />
            </Link>
            <Link href="https://github.com/mskubarc" target="_blank">
                <img src="githubImg/mskubarc.png" />
            </Link>
            <Link href="https://github.com/TestkaJakub" target="_blank">
