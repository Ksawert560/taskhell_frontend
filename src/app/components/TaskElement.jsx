...
function TaskElement({ taskID, taskName, onTaskDelete, onTaskFinish, isFinished, onTaskUnfinish ,showEditTask, hideEditTask, isEditTaskVisible}) {
    ...
    <div className="taskElement" style={styles.page}>
      ...
      {isMenuVisible ? (
        <div ref={hiddenMenuRef} className="taskElementHiddenMenu">
          ...
          {isFinished? <p onClick={() => onTaskUnfinish(taskID)}>unfinished</p> : <p onClick={() => onTaskFinish(taskID)}>finished</p>}
