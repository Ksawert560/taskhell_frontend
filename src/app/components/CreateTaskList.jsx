...
const handleSubmit = async (e) => {
    ...
    if(isEmpty()){
      try {
        ...
        data.append('name', formData.listName);
        const jsonData = {};
  ...
  return (
    <section className="createListContainer" style={styles.page}>
        <div>
            <h2>CREATE NEW TO-DO-LIST</h2><svg className="menuClose" onClick={onClose} xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#000000" viewBox="0 0 256 256"><path d="M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,61.66,205.66a8,8,0,0,1-11.32-11.32L116.69,128,50.34,61.66A8,8,0,0,1,61.66,50.34L128,116.69l66.34-66.35a8,8,0,0,1,11.32,11.32L139.31,128Z"></path></svg>
        </div>
        <form onSubmit={handleSubmit}>
                <input type="text" name="listName" placeholder="list name" onChange={handleChange} value={formData.listName}/>
